...
export default function SalesPage() {
  ...
  if (loading) {
    return <div className="p-8 text-black font-sans">Loading leads...</div>;
  }
    ...
    <div className="p-8 font-sans max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Manage borrower leads who haven't applied for a loan yet.</p>
        </div>
      </div>
              ...
              {leads.length === 0 ? (
                ...
                leads.map((lead) => (
                  <tr key={lead._id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-medium text-black">{lead.fullName}</td>
